<template>
  <div id="airport-result" v-if="record !== null" data-toggle="collapse" :data-target="'#reservation_' + _uid + '_block'" aria-expanded="false" :aria-controls="'reservation_' + _uid + '_block'">
        <div class="block-content block-content-full clearfix">
          <div class="d-flex flex-row align-items-start">
            ...
            <div class="align-self-stretch ml-auto text-right">
              <div class="font-size-h3 font-w600">{{ price }}$</div>
              <div class="font-size-sm font-w600 text-lowercase text-muted">one way</div>
            </div>
          </div>

          <div class="collapse" :id="'reservation_' + _uid + '_block'">
            ...
            <div class="d-flex flex-column align-items-start">
              <div class="d-flex flex-row align-self-stretch">
                ...
                <div class="align-self-stretch ml-auto">
              ...
              <div class="align-self-end ml-auto text-right">
                <button type="button" class="btn btn-alt-primary" @click="select(data)">SELECT</button>
              </div>
            </div>
